...
<title>Radiology Information System - Home</title>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Radiology Information System</a>
        </div>
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <%
				...
				{
				    out.println("<li><a href=\"#userManagement\">User Management</a></li><li><a href=\"#reports\">Reports</a></li><li><a href=\"#dataAnalysis\">Data Analysis</a></li>");
				}
