...
<div class="container">
	<form name="RecordForm" action="uploadRecord.jsp" method="post" role="form">
		...
		Prescribing Date:
		<br>
		<input type="text" name="PRESCRIBE" size="12" maxlength="11" placeholder="DD-MMM-YYYY" required>
		<br>
		Test Date:
		<br>
		<input type="text" name="TESTDATE" size="12" maxlength="11" placeholder="DD-MMM-YYYY" required>
		<br>
		Diagnosis:
		<br>
